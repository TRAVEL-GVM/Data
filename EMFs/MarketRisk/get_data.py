...
if __name__ == "__main__":
    ...
    # save data
    df_benchmarks.to_csv("Data/Market Risk/df_benchmarks.csv")
    df_hpi.to_csv("Data/Market Risk/df_hpi.csv")
    df_aux_cppi.to_csv("Data/Market Risk/df_aux_cppi.csv")
    df_greed_fear.to_csv("Data/Market Risk/df_greed_fear.csv")
    df_warren_buff.to_csv("Data/Market Risk/df_warren_buff.csv")
    df_ipc_pt.to_csv("Data/Market Risk/df_ipc_pt.csv")
    df_eur.to_csv("Data/Market Risk/df_eur.csv")
    df_fx.to_csv("Data/Market Risk/df_fx.csv")
    df_key_ecb_ir.to_csv("Data/Market Risk/df_key_ecb_ir.csv")
    df_ir_str.to_csv("Data/Market Risk/df_ir_str.csv")
